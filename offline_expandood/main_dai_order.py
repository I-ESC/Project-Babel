...
def main(args):
    ...
    train_data =  torch.load('all_nonaug.pt')
    train_dataset = datasets_kinetics.MyDataset('train', train_data)
    ...
    train_loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.batch_size, shuffle=(train_sampler is None), sampler=train_sampler, drop_last=True)
    ...
    m_schedule = utils.cosine_scheduler(args.m, args.m_end, args.epochs,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_stats = train(train_loader, model, criterion, optimizer, scaler, epoch, lr_schedule, m_schedule, args)
...
def train(train_loader, model, criterion, optimizer, scaler, epoch, lr_schedule, m_schedule, args):
