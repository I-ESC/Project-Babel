...
class ImprovedMLP(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_classes, num_layers, num_features=2, weights=None, dropout_prob=0.5):
        super().__init__()
        self.num_features = num_features
        self.weights = weights if weights is not None else [1] * num_features
...
class ClassifierCNN1D(nn.Module):
    def __init__(self, input_dim=512, num_classes=27):
        super(ClassifierCNN1D, self).__init__()
